        ...
        <DropdownMenuTrigger asChild className="cursor-pointer hover:opacity-50">
          <div className="size-11 p-3 rounded-full bg-muted border border-gray-200">
            <div className="relative">
              ...
              <span className="absolute -top-2 border-2 border-muted -right-2.5 text-[10px] rounded-full size-5 text-center place-content-center text-white bg-accent">
                      ...
                      <div className='grid grid-cols-4 w-full'>
                        ...
                        <div className="col-span-3 flex flex-col">
                          <div className="space-y-1">
                            ...
                            {cartItem.option && <p className="text-sm text-muted-foreground">Dung tích: {cartItem.option.name}</p>}
                          </div>
                          <div className="grid grid-cols-10 mt-auto h-5 items-center space-x-4 text-sm">
                            ...
                            <div className="col-span-2 text-center flex items-center"><X className='size-4'/> {cartItem.quantity}</div>
                            <Separator orientation="vertical" />
                            <Trash2
