    ...
    <div className="lg:col-span-2 lg:border-gray-200 lg:pr-8">
      <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
        ...
        <div className="mt-2 text-sm text-gray-600">
            <p>Nhà cung cấp: <span className="font-medium text-gray-800">{product.supplierName}</span></p>
            <p>Loại sản phẩm: <span className="font-medium text-gray-800">{product.productType}</span></p>
        </div>
