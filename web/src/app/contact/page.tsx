    ...
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="mb-10 lg:mb-0">
          <div className="group h-full w-full">
            <div className="relative h-full">
              <div className="bg-primary h-full w-full rounded-2xl object-cover bg-blend-multiply lg:rounded-l-2xl" />
              <div className="absolute bottom-0 w-full p-5 lg:p-11">
                <div className="block space-y-4 rounded-lg bg-white p-6">
                  <div className="flex items-center">
                    <Phone className="text-primary" />
                    <h5 className="ml-4 text-base">470-601-1911</h5>
                  </div>
                  <div className="flex items-center">
                    <Mail className="text-primary" />
                    <h5 className="ml-4 text-base">Pagedone1234@gmail.com</h5>
                  </div>
                  <div className="flex items-center">
        ...
        <div className="p-4 lg:p-11">
          <h2 className="text-primary mb-11 text-4xl font-semibold">
          ...
          <Form {...sendContactForm}>
            <form
              className="space-y-6"
              onSubmit={sendContactForm.handleSubmit(onSummitSendContactForm)}
            >
              <FormField
                  ...
                  <FormItem className="grid !space-y-1">
                    ...
                    <FormControl>
                      <Textarea
                        rows={8}
                        {...field}
                        className="border-input rounded-md border p-3 shadow-sm"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
