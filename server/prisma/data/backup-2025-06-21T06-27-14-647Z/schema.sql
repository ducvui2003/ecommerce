...
ALTER TABLE IF EXISTS ONLY public.products DROP CONSTRAINT IF EXISTS products_thumbnail_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.product_resources DROP CONSTRAINT IF EXISTS product_resources_resource_id_fkey;
ALTER TABLE IF EXISTS ONLY public.product_resources DROP CONSTRAINT IF EXISTS product_resources_product_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.options DROP CONSTRAINT IF EXISTS options_resource_id_fkey;
ALTER TABLE IF EXISTS ONLY public.options DROP CONSTRAINT IF EXISTS options_product_id_fkey;
...
DROP INDEX IF EXISTS public.cart_items_cart_id_product_id_option_id_key;
...
ALTER TABLE IF EXISTS public."CommentLike" ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public."CommentLike_id_seq";
...
--
-- Name: CommentLike_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: CommentLike_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: CommentLike id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: cart_items_cart_id_product_id_option_id_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: options options_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: options options_resource_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: product_resources product_resources_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: product_resources product_resources_resource_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: products products_thumbnail_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
